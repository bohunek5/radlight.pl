...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await page.screenshot(path=os.path.join(output_dir, "v_contact_night.png"), full_page=False)

        # 2. Index Stats section Night
        await page.locator("#o-nas").scroll_into_view_if_needed()
        await page.wait_for_timeout(300)
        await page.screenshot(path=os.path.join(output_dir, "v_stats_night.png"), full_page=False)

        await browser.close()
        print("Contact & stats screenshots captured!")
