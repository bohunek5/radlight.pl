...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await page.screenshot(path=os.path.join(output_dir, "v_apartamenty_no_stats_night.png"), full_page=False)

        # Apartamenty Day
        await page.locator("#theme-toggle-btn").click()
        await page.wait_for_timeout(300)
        await page.screenshot(path=os.path.join(output_dir, "v_apartamenty_no_stats_day.png"), full_page=False)
